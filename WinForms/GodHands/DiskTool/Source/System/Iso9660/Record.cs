...
namespace GodHands {
    public class Record : BaseClass, ISubscriber {
        ...
        base(parent, url, pos) {
            ...
            if (FileFlags_Directory) {
                binary = new Folder(this, url+"/Data", LenData);
            } else {
                binary = new Binary(this, url+"/Data", LenData);
            }
            Publisher.Register(binary);
            Publisher.Subscribe(binary, this);
        }
